...
COPY src /usr/src/dubai/
WORKDIR /usr/src/dubai
...
RUN chmod +x /usr/src/dubai/tasks.py \
    && chmod +x /usr/src/dubai/entrypoint.sh
...
# ENTRYPOINT /usr/src/dubai/entrypoint.sh
